...
Route::post('/ferramenta', [FerramentController::class, 'store'])->name('ferramenta.save');
Route::get('/ferramenta/edit/{id}', [FerramentController::class, 'edit']);
Route::put('/ferramenta/update/{id}', [FerramentController::class, 'update'])->middleware('auth')->name('ferramenta.update');
