        ...
        <div class="mx-auto mb-4" style="width: 710px;">
            ...
            <form action="/funcionario/register/save" method="POST"  style="width:65%; margin:auto">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="cpf"class="form-control @error('cpf') is-invalid @enderror" value="{{ old('cpf') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="setor"class="form-control @error('setor') is-invalid @enderror" value="{{ old('setor') }}">
